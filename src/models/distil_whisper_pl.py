...
class DistilWhisperPL(ASRModel):
    def __init__(self, device: str = "auto", compute_type: str = "auto"):
        self.model = FWModel("mmalyska/distil-whisper-large-v3-pl-ct2", device=device, compute_type=compute_type)
...
register_model("distil-whisper-pl", DistilWhisperPL)
